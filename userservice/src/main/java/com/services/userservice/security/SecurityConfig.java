...
public class SecurityConfig {
    ...
    // return builder -> {
    // builder.modules(SecurityJackson2Modules.getModules(CustomUserDetails.class.getClassLoader()));
    // builder.mixIn(CustomUserDetails.class, CustomUserDetailsMixin.class);
    // builder.mixIn(User.class, UserMixin.class);
    // builder.mixIn(Role.class, RoleMixin.class);
